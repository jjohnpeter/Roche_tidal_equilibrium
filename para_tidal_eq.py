...
#Qbh = 0.2    # BH mass in Msun
#sma = 1.5    # SMA in Rsun
npoly = 1.5   # polytropic index

# --- accuracy of BC requires large Lmax, but grid resolution is better at small Lmax
#Lmax = 0.09  # maximum box size for Poisson solver (reasonable size: ~2.0)
Nresz = 200    # resolution per dimension (reasonable resolution: 100 to 150)
