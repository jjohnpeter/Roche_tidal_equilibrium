...
# example run
# python tidal_equilibrium_MS_K.py 0.578 2.043 2.0
...
# Get Rstar from Mstar via MS mass-rad relation
...
if Niter == 0:   # start from scratch
    ...
    rhoname_initial = dir_main + 'MS_K_runs/polytrope_profile_npoly%.5f.txt' % npoly
